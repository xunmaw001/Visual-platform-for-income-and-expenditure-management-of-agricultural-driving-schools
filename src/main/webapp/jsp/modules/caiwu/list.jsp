...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>财务管理</span></li>
								<li class="breadcrumb-item active"><span>财务列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">财务列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										财务账号
									</label>
									<input type="text" id="caiwuzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入财务账号" aria-controls="tableId">
									<label>
										财务姓名
									</label>
									<input type="text" id="caiwuxingmingSearch" class="form-control form-control-sm" placeholder="请输入财务姓名" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#caiwuzhanghaoSearch').val() != null && $('#caiwuzhanghaoSearch').val() != ''){
				searchForm.caiwuzhanghao ="%" +  $('#caiwuzhanghaoSearch').val() + "%";
			}
			
			if($('#caiwuxingmingSearch').val() != null && $('#caiwuxingmingSearch').val() != ''){
				searchForm.caiwuxingming ="%" +  $('#caiwuxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("caiwu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				caiwuzhanghao : searchForm.caiwuzhanghao,	
				caiwuxingming : searchForm.caiwuxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("caiwu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"caiwu");
