	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">财务账号</label> 
							<input  name="caiwuzhanghao" placeholder="财务账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">财务姓名</label> 
							<input  name="caiwuxingming" placeholder="财务姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "caiwu/register";
				$.ajax({ 
					type: "POST",
					url: url,
