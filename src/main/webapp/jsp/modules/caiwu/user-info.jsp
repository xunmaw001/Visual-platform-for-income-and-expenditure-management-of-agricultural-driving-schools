					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑财务</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">财务信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>财务账号</label>
										<input name="caiwuzhanghao" readonly id="caiwuzhanghao" name="caiwuzhanghao" class="form-control" placeholder="财务账号">
									</div>
									<div class="form-group col-md-6">
										<label>财务姓名</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("caiwu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
