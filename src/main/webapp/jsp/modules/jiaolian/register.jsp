	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">教练账号</label> 
							<input  name="jiaolianzhanghao" placeholder="教练账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">教练姓名</label> 
							<input  name="jiaolianxingming" placeholder="教练姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "jiaolian/register";
				$.ajax({ 
					type: "POST",
					url: url,
