...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>教练管理</span></li>
								<li class="breadcrumb-item active"><span>教练列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jiaolianzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入教练账号" aria-controls="tableId">
									<label>
										教练姓名
									</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#jiaolianzhanghaoSearch').val() != null && $('#jiaolianzhanghaoSearch').val() != ''){
				searchForm.jiaolianzhanghao ="%" +  $('#jiaolianzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jiaolian/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				jiaolianzhanghao : searchForm.jiaolianzhanghao,	
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jiaolian");
