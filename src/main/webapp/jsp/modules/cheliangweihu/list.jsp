...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">车辆维护管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>车辆维护列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">车辆维护列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('weihuleixing')">维护类型<i id="weihuleixingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('weihujine')">维护金额<i id="weihujineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('weihushijian')">维护时间<i id="weihushijianIcon" class="fa fa-sort"></i></th>
											<th>维护内容</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var weihuleixingCell  = document.createElement('td');

						 weihuleixingCell.innerHTML = item.weihuleixing;

			row.appendChild(weihuleixingCell);
			var weihujineCell  = document.createElement('td');

						 weihujineCell.innerHTML = item.weihujine;

			row.appendChild(weihujineCell);
			var weihushijianCell  = document.createElement('td');

						  weihushijianCell.innerHTML = item.weihushijian;


			row.appendChild(weihushijianCell);
			var weihuneirongCell  = document.createElement('td');

						  if(item.weihuneirong != null && item.weihuneirong != "" && item.weihuneirong.length >= 11){
			  	weihuneirongCell.innerHTML = item.weihuneirong.substring(0, 10) + "..."; 
			  }else{
			  	weihuneirongCell.innerHTML = item.weihuneirong;
			  }


			row.appendChild(weihuneirongCell);
		...
		function sh(){
			...
			httpJson("cheliangweihu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cheliangweihu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"cheliangweihu");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"cheliangweihu");
