...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chejiahao')">车架号<i id="chejiahaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('huandangfangshi')">换挡方式<i id="huandangfangshiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('cheliangnianxian')">车辆年限<i id="cheliangnianxianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chejiahaoCell  = document.createElement('td');

						 chejiahaoCell.innerHTML = item.chejiahao;

			row.appendChild(chejiahaoCell);
			...
			var cheliangnianxianCell  = document.createElement('td');

						 cheliangnianxianCell.innerHTML = item.cheliangnianxian;

			row.appendChild(cheliangnianxianCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "维护"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'cheliangweihu','','','')");
