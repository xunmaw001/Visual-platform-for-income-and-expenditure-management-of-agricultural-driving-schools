...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="feiyongmingchengSearch" class="form-control form-control-sm" placeholder="请输入费用名称" aria-controls="tableId">
									<label>
										费用类型
									</label>
									<input type="text" id="feiyongleixingSearch" class="form-control form-control-sm" placeholder="请输入费用类型" aria-controls="tableId">
                                    <label>
                                        是否通过
                                    </label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('feiyongmingcheng')">费用名称<i id="feiyongmingchengIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('feiyongleixing')">费用类型<i id="feiyongleixingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('feiyongjine')">费用金额<i id="feiyongjineIcon" class="fa fa-sort"></i></th>
											<th>费用描述</th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#feiyongmingchengSearch').val() != null && $('#feiyongmingchengSearch').val() != ''){
				searchForm.feiyongmingcheng ="%" +  $('#feiyongmingchengSearch').val() + "%";
			}
			
			if($('#feiyongleixingSearch').val() != null && $('#feiyongleixingSearch').val() != ''){
				searchForm.feiyongleixing ="%" +  $('#feiyongleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jiaofeixinxi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				feiyongmingcheng : searchForm.feiyongmingcheng,	
				feiyongleixing : searchForm.feiyongleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var feiyongmingchengCell  = document.createElement('td');

						 feiyongmingchengCell.innerHTML = item.feiyongmingcheng;

			row.appendChild(feiyongmingchengCell);
			var feiyongleixingCell  = document.createElement('td');

						 feiyongleixingCell.innerHTML = item.feiyongleixing;

			row.appendChild(feiyongleixingCell);
			var feiyongjineCell  = document.createElement('td');

						 feiyongjineCell.innerHTML = item.feiyongjine;

			row.appendChild(feiyongjineCell);
			var feiyongmiaoshuCell  = document.createElement('td');

						  if(item.feiyongmiaoshu != null && item.feiyongmiaoshu != "" && item.feiyongmiaoshu.length >= 11){
			  	feiyongmiaoshuCell.innerHTML = item.feiyongmiaoshu.substring(0, 10) + "..."; 
			  }else{
			  	feiyongmiaoshuCell.innerHTML = item.feiyongmiaoshu;
			  }


			row.appendChild(feiyongmiaoshuCell);
		...
		function sh(){
			...
			httpJson("jiaofeixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
