	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">学员账号</label> 
							<input  name="xueyuanzhanghao" placeholder="学员账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="xueyuanxingming" placeholder="学员姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xueyuan/register";
				$.ajax({ 
					type: "POST",
					url: url,
